...
//the PHP portion of this script supplies the proper wall paper depending on location of user (WPL, HWB)
...
*/
      ...
      wallpaper: function() {
        ...
        if ($('#desktop').length) {
          $('body').prepend('<img id="wallpaper" class="abs" src="/assets/images/<?PHP echo $_SESSION['location_wallpaper_image']; ?>" />');
        }
      }
    },
    util: {
